...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2022 at 05:22 PM
...
('B0012', 'Komputer', 'sd', 'Asus', 'Baru', 9, 'Unit', 'K001'),
...
CREATE TABLE IF NOT EXISTS `barang_inventaris` (
...
('B0012.000064', 'B0012', 'BB00009', '2022-06-14', '2022', '', '', '', '', '', '', 1000000, 'contoh', 'Ditempatkan', 'P0001'),
...
(2, 'P002', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No'),
(3, 'P003', 'No', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'No', 'Yes', 'Yes', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No'),
(5, 'P004', 'No', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'No', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'No', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'No', 'No', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes'),
(7, 'P005', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No');
...
CREATE TABLE IF NOT EXISTS `mutasi_asal` (
  `id` int(4) NOT NULL,
  `no_mutasi` char(7) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mutasi_tujuan` (
  `no_mutasi` char(7) NOT NULL,
  `no_penempatan` char(7) NOT NULL,
  `keterangan` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `penempatan_item` (
  `no_penempatan` char(7) NOT NULL,
  `kd_inventaris` char(12) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pengadaan_item` (
  `no_pengadaan` char(7) NOT NULL,
  `kd_barang` char(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `resume_inventaris` (
  `id` int(11) NOT NULL,
  `kd_inventaris` char(12) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tmp_mutasi` (
  `id` int(4) NOT NULL,
  `no_penempatan` char(7) NOT NULL,
  `kd_inventaris` char(12) NOT NULL,
  `kd_petugas` char(4) NOT NULL
...
CREATE TABLE IF NOT EXISTS `tmp_peminjaman` (
  `id` int(4) NOT NULL,
  `kd_petugas` char(4) NOT NULL,
  `kd_inventaris` char(12) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tmp_penempatan` (
  `id` int(4) NOT NULL,
  `kd_petugas` char(4) NOT NULL,
  `kd_inventaris` char(12) NOT NULL
...
CREATE TABLE IF NOT EXISTS `tmp_pengadaan` (
  `id` int(4) NOT NULL,
  `kd_petugas` char(4) NOT NULL,
  `kd_barang` char(5) NOT NULL,
  `deskripsi` varchar(100) NOT NULL,
