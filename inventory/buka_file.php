...
if($_GET) {
	...
	switch($_GET['open']){				
		...
		case 'Laporan-Cetak' :
			...
			case 'Laporan-Pengadaan-Departemen' :				
				if(!file_exists ("laporan_pengadaan_departemen.php")) die ("File tidak ditemukan !"); 
				include "laporan_pengadaan_departemen.php"; break;
