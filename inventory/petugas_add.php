...
if(isset($_POST['btnSimpan'])){
	...
	$rbPemeliharaan		=  $_POST['rbPemeliharaan'];
	...
	if (count($pesanError)>=1 ){
		...
		$mySql  	= "INSERT INTO petugas (kd_petugas, nm_petugas, kelamin, alamat, no_telepon,  username, password, level)
						VALUES ('$kodeBaru', 
								'$txtNama', 
								'$cmbKelamin',
								'$txtAlamat', 
		...
		if($myQry){
			...
			$my2Sql  = "INSERT INTO hak_akses SET 
							...
							mu_trans_pemeliharaan = '$rbPemeliharaan',
...
$dataPemeliharaan 		= isset($_POST['rbPemeliharaan']) ? $_POST['rbPemeliharaan'] : 'No';
	if($dataPemeliharaan =="No") { $pilihPemeliharaanN = "checked"; $pilihPemeliharaanY = ""; } else { $pilihPemeliharaanN = ""; $pilihPemeliharaanY = "checked"; }
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self"  enctype="multipart/form-data">
  <table width="100%" class="table-list" border="0" cellspacing="1" cellpadding="4">
    ...
    <tr>
      <td bgcolor="#F5F5F5"><strong>LOGIN</strong></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><strong>Transaksi Peminjaman</strong></td>
      <td><b>:</b></td>
    ...
    <tr>
      <td><strong>Transaksi Pemeliharaan </strong></td>
      <td><b>:</b></td>
      <td><input name="rbPemeliharaan" type="radio" value="No" <?php echo $pilihPemeliharaanN; ?> />
        No
        <input name="rbPemeliharaan" type="radio" value="Yes" <?php echo $pilihPemeliharaanY; ?>/>
        Yes</td>
    </tr>
    <tr>
