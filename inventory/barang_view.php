...
<table class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td width="180" bgcolor="#F5F5F5"><strong>Pegawai Yang Menggunakan</strong></td>
    <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>Tools</strong></td>
  </tr>
  <?php
	// Skrip menampilkan daftar Inventaris Aset Barang per Barang
	$mySql = "SELECT * FROM barang_inventaris  inner join pegawai on barang_inventaris.pegawai_yang_menggunakan = pegawai.kd_pegawai WHERE kd_barang='$Kode'";  
	$myQry = mysql_query($mySql, $koneksidb)  or die ("Query salah : ".mysql_error());
	$nomor = 0; 
	while ($myData = mysql_fetch_array($myQry)) {
		$nomor++;
		$KodeInventory = $myData['kd_inventaris'];
    $pegawai = $myData['nm_pegawai'];
