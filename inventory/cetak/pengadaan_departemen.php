...
if ($kodeDepartemen =="Semua") {
  ...
  // SQL filter data
  $filterSQL = "WHERE pengadaan.kd_departemen='$kodeDepartemen' AND LEFT(pengadaan.tgl_pengadaan,4)='$dataTahun'";
  
  // Mendapatkan informasi nama departemen
  $infoSql = "SELECT nm_departemen FROM departemen WHERE kd_departemen='$kodeDepartemen'";
...
<html>
<head>
<title>:: Laporan Pengadaan per Departemen - Inventory Kantor (Aset Barang)</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link href="../styles/styles_cetak.css" rel="stylesheet" type="text/css"></head>
<body onLoad="window.print()">
<h2>LAPORAN PENGADAAN PER departemen </h2>
<table width="500" border="0"  class="table-list">
  <tr>
    <td colspan="3" bgcolor="#F5F5F5"><strong>KETERANGAN </strong></td>
  </tr>
  <tr>
    <td width="132"><b> departemen </b></td>
    <td width="5"><b>:</b></td>
    <td width="349"><?php echo $namadepartemen; ?></td>
  </tr>
  <tr>
